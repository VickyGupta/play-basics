 ...
 * List[Int]
 */
trait TraitUpdateList {
  def updateList(index:Int,value:Int):List[Int]
}
 ...
 */
@Singleton
class UpdateList @Inject() (g:GetList) extends TraitUpdateList {  
 
  override def updateList(index:Int,value:Int)={
      var i:Int=0;
      var list=g.getList()
